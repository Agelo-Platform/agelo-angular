...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      // Project-scoped teams and team detail. The TeamsComponent reads the
      // route's optional `projectId` and scopes its list to that project.
      {
        path: 'org/:orgId/project/:projectId/teams',
        loadComponent: () =>
          import('./features/teams/teams.component').then((m) => m.TeamsComponent),
      },
      {
        path: 'org/:orgId/project/:projectId/teams/:teamId',
        loadComponent: () =>
          import('./features/teams/team-detail.component').then(
            (m) => m.TeamDetailComponent,
          ),
      },
      // Per-project Settings page — currently only "API keys" since
      // project-scoped settings are limited. Adding more tabs later
      // can grow this in place.
      {
        path: 'org/:orgId/project/:projectId/settings',
        loadComponent: () =>
