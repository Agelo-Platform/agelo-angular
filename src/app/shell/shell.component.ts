...
@Component({
  ...
  styles: [`
    ...
    .shell { height: 100vh; }
    .sider { background: var(--c-surface); }
    .brand {
    ...
    .divider { margin: 6px 0 !important; border-color: var(--c-border-subtle) !important; }
    ...
    .bc-sep { color: var(--c-text-subtlest); font-size: 18px; }
    .spacer { flex: 1; }
    .user-chip {
    ...
    .user-chip:hover { color: var(--c-primary); text-decoration: none; }
