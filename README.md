...
```bash
# Public packages pull anonymously. If this package is still private,
# authenticate first:
...
For the full stack (backend + database + website) follow the
[Run with Docker Compose](https://agelo.app/docs/platform/docker-compose/)
guide — its Compose file boots all four services straight from GHCR.
